...
class LowLightImageCorruptionConfig:
    ...
    defocus_probability: float = 0.80
    defocus_sigma_px: tuple[float, float] = (0.3, 1.6)
    motion_probability: float = 0.65
    motion_length_px: tuple[int, int] = (3, 9)
    downsample_probability: float = 0.35
    downsample_scale: tuple[float, float] = (0.65, 0.95)
    photon_count: tuple[float, float] = (900.0, 6000.0)
    read_noise_std: tuple[float, float] = (0.5 / 255.0, 2.5 / 255.0)
